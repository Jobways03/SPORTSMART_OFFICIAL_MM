  ...
  return (
    <div className="profile-page">
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 20 }}>
        ...
        <ActionBtn label="Update Verification" onClick={() => setActiveModal('verification')} />
          ...
          <div className="form-grid-2">
            <div className="profile-form-group">
              ...
              <input id="city" type="text" value={formData.city}
                onChange={e => updateField('city', e.target.value)} onBlur={() => handleBlur('city')}
                aria-invalid={!!errors.city} disabled={isSaving} placeholder="City" />
            ...
            <div className="profile-form-group">
              ...
              <input id="state" type="text" value={formData.state}
                onChange={e => updateField('state', e.target.value)} onBlur={() => handleBlur('state')}
                aria-invalid={!!errors.state} disabled={isSaving} placeholder="State / Province" />
          ...
          <div className="form-grid-2">
            ...
            <div className="profile-form-group">
              ...
              <input id="sellerZipCode" type="text" value={formData.sellerZipCode}
                onChange={e => updateField('sellerZipCode', e.target.value)} onBlur={() => handleBlur('sellerZipCode')}
