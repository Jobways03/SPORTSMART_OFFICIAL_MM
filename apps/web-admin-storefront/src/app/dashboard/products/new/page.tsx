...
export default function CreateProductPage() {
  ...
  function validate(): boolean {
    ...
    // Platform price validation (optional — can be set later)
    // Stock is managed by sellers, not admin
    setErrors(errs);
      ...
      <div className="form-card">
        ...
        {form.hasVariants && (
          <div className="info-box">
            Set platform pricing here. Stock and SKU will be managed by sellers who map to this product.
          </div>
        )}
