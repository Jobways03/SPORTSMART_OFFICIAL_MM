...
function FranchiseLoginInner() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const result = await franchiseAuthService.login({
      ...
      if (result.data) {
        try {
          ...
          sessionStorage.setItem('franchise', JSON.stringify(result.data.franchise));
        } catch {
          // Storage unavailable
        }
        ...
        <aside className="auth-brand">
          <div className="auth-brand-content">
            ...
            <p className="auth-brand-text">
              Sign in to your Sportsmart franchise dashboard — orders, inventory,
              procurement, and POS in one place.
            </p>
