...
// Mirrors apps/web-storefront/src/services/wishlist.service.ts — same shape
// the backend WishlistItem from apps/api/src/modules/wishlist/ returns. The
// list response embeds enough product/variant info to render a row without
// a second roundtrip.
...
export const wishlistService = {
  ...
  remove(itemId: string): Promise<ApiResponse<void>> {
    return apiClient<void>(`/customer/wishlist/${itemId}`, {method: 'DELETE'});
  },
};
