...
export default function CreateProductPage() {
  ...
  function buildPayload() {
    ...
    // Tax & GST (HSN, rate, supply type, cess, UQC, tax category) is set by
    // a super-admin only — never sent from this form.
  ...
  async function handleSave() {
    ...
    try {
      ...
      // (was misleading "saved as draft" toast). See Phase 32 audit
      // report — same fix applied across all admin panels.
      if (res.data?.id) {
