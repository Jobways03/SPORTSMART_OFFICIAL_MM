        ...
        <div className="franchise-detail-main">
                ...
                {editMode ? (
                  <div className="info-grid">
                    <div className="form-group">
                      ...
                      <input value={editForm.ownerName || ''} maxLength={100} onChange={e => setEditForm(p => ({ ...p, ownerName: filterPersonNameInput(e.target.value) }))} />
                    </div>
                    <div className="form-group">
                      <label>Email</label>
                ...
                {editMode ? (
                  <div className="info-grid">
                    <div className="form-group">
                      ...
                      <input value={editForm.businessName || ''} maxLength={150} onChange={e => setEditForm(p => ({ ...p, businessName: filterBusinessNameInput(e.target.value) }))} />
                    </div>
                    <div className="form-group">
          ...
          {activeTab === 'location' && (
            <>
                ...
                {editMode ? (
                  <div className="info-grid">
                    <div className="form-group" style={{ gridColumn: '1 / -1' }}>
                      <label>Address</label>
                      <textarea rows={2} value={editForm.address || ''} onChange={e => setEditForm(p => ({ ...p, address: e.target.value }))} />
                    </div>
                    <div className="form-group"><label>Pincode</label><input value={editForm.pincode || ''} inputMode="numeric" maxLength={6} onChange={e => setEditForm(p => ({ ...p, pincode: e.target.value.replace(/\D/g, '').slice(0, 6) }))} /></div>
                    <div className="form-group"><label>Country</label><input value={editForm.country || ''} onChange={e => setEditForm(p => ({ ...p, country: e.target.value }))} /></div>
                    <div className="form-group"><label>City / District</label><input value={editForm.city || ''} onChange={e => setEditForm(p => ({ ...p, city: e.target.value }))} /></div>
                    <div className="form-group"><label>State</label><input value={editForm.state || ''} onChange={e => setEditForm(p => ({ ...p, state: e.target.value }))} /></div>
                    <div className="form-group" style={{ gridColumn: '1 / -1' }}><label>Locality</label><input value={editForm.locality || ''} onChange={e => setEditForm(p => ({ ...p, locality: e.target.value }))} /></div>
                  </div>
                ) : (
                  <div className="info-grid">
                ...
                {editMode ? (
                  <div className="info-grid">
                    <div className="form-group" style={{ gridColumn: '1 / -1' }}>
                      ...
                      <textarea rows={2} value={editForm.warehouseAddress || ''} onChange={e => setEditForm(p => ({ ...p, warehouseAddress: e.target.value }))} />
                    </div>
                    <div className="form-group"><label>Warehouse Pincode</label><input value={editForm.warehousePincode || ''} inputMode="numeric" maxLength={6} onChange={e => setEditForm(p => ({ ...p, warehousePincode: e.target.value.replace(/\D/g, '').slice(0, 6) }))} /></div>
                  </div>
                ) : (
                  <div className="info-grid">
              ...
              {editMode && (
                <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end', marginTop: 16 }}>
                  <button className="btn btn-secondary" onClick={() => { setEditMode(false); if (franchise) initEditForm(franchise); }} disabled={editSaving}>Cancel</button>
