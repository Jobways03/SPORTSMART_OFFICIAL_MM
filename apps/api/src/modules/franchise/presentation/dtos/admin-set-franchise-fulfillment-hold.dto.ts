 ...
 * risk/fraud FULFILLMENT HOLD on a franchise. A held franchise is excluded
 * from the allocation engine (it can be neither auto-routed nor manually
 * reassigned new orders), so the reason is MANDATORY: ops must record *why*
 * the node was benched before it silently stops receiving work.
 *
 ...
 */
export class AdminSetFranchiseFulfillmentHoldDto {
