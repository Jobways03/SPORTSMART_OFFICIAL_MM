...
export default function InitiateRefundModal({
  ...
  const handleSubmit = async () => {
    ...
    setError('');
    try {
      await franchiseReturnsService.initiateRefund(
        returnId,
        franchiseId,
      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div style={{ fontSize: 13, color: 'var(--color-text-secondary)', marginBottom: 16 }}>
            ...
            <strong style={{ color: 'var(--color-text)' }}>{returnNumber}</strong>. If a
            method is not selected the original payment method will be used.
          </div>
