...
export default function ConfirmRefundModal({
  ...
  const handleSubmit = async () => {
    ...
    setError('');
    try {
      await franchiseReturnsService.confirmRefund(returnId, franchiseId, {
      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div style={{ fontSize: 13, color: 'var(--color-text-secondary)', marginBottom: 16 }}>
            ...
            <strong style={{ color: 'var(--color-text)' }}>{returnNumber}</strong>. Enter
            the payment gateway / bank transaction reference below.
          </div>
