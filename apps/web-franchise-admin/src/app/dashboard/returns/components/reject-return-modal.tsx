...
export default function RejectReturnModal({
  ...
  const handleSubmit = async () => {
    ...
    setError('');
    try {
      await franchiseReturnsService.reject(returnId, franchiseId, trimmed);
      onSuccess();
    } catch (err) {
      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="modal-warning">
            Rejecting return <strong>{returnNumber}</strong> cannot be undone. The
            customer will be notified with the reason you provide below.
          </div>
