              ...
              <tbody>
                {products.map(product => (
                  <tr key={product.id}>
                    ...
                    <td>
                      {(() => {
                        // Phase 32 (2026-05-21) — prefer the structured
                        // moderation columns. rejectionReason fires for
                        // REJECTED; changeRequestNote for CHANGES_REQUESTED.
                        // Fall back to the legacy moderationNote for rows
                        // written before the dual-write landed.
                        const note =
