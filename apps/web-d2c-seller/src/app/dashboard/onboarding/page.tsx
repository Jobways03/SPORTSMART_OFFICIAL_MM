...
export default function SellerOnboardingPage() {
  ...
  const validationErrors = useMemo<string[]>(() => {
    ...
    // Account holder name is a PERSON NAME — alphabets only (no digits,
    // no special characters beyond space / period / apostrophe / hyphen).
    const holderNameErr = validatePersonName(
      form.bankAccountHolderName,
      'Bank account holder name',
    );
    if (holderNameErr) errs.push(`${holderNameErr}.`);
