...
/**
 * RETAIL seller-admin variant of the partner-registration panel. The
 * staff member is logged in as a SportsMart admin and operates on a
 * specific seller's behalf, so the panel takes `sellerId` as a prop
 * (resolved by the mounting page from a `?sellerId=` query param) and
 * calls the admin endpoints. The `X-Seller-Type: RETAIL` header is
